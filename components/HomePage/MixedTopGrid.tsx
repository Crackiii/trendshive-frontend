...
function TopGrid(props?: Props) {
  ...
  return (
    <>
     <div className="hidden mt-6 grid-rows-1 grid-cols-1 gap-0 grid-flow-row sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6">
      {
